...
INPUT_GEOJSONS = [
    ...
    "/Users/norahunger/Documents/ODIS/Erfrischungskarte/2026/Brunnen/straßenbrunnen_berlin.geojson"
]
...
def main():
    ...
    print(
        ...
        f"- Test-GeoJSON: {OUTPUT_GEOJSON}\n"
        f"- Test-CSV: {OUTPUT_CSV}\n"
        f"- Test-Dubletten-Report: {OUTPUT_DUPLICATES_CSV}"
    )
