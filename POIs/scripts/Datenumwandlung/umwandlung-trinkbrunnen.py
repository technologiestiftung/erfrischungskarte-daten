...
INPUT_GEOJSON = "/Users/norahunger/Documents/ODIS/Erfrischungskarte/2026/Trinkbrunnen/trinkbrunnen_roh.geojson"
OUTPUT_GEOJSON = "/Users/norahunger/Documents/GitHub/erfrischungskarte-daten/POIs/single-files/2026/GeoJSON/trinkbrunnen-formatiert.geojson"
OUTPUT_CSV = "/Users/norahunger/Documents/GitHub/erfrischungskarte-daten/POIs/single-files/2026/CSV/trinkbrunnen-formatiert.csv"
...
def main():
    ...
    for feat in in_features:
        ...
        # === Anpassungen laut Wunsch ===
        # 1) Name niemals leer -> Default "Trinkbrunnen"
        if name is None or str(name).strip() == "":
            name = "Trinkbrunnen"

        # 2) Falls info "Trinkbrunnen" (case-insensitive, getrimmt) -> info = None
        if info is not None and str(info).strip().lower() == "trinkbrunnen":
            info = None
        # ===============================
        ...
        out_feat = {
            "type": "Feature",
            "properties": {
                "name": name,          # garantiert nicht None/leer
